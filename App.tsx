    ...
    <div className="relative min-h-screen">
      ...
      <footer className="py-8 mt-12 relative z-10">
        <div className="max-w-3xl mx-auto text-center px-4">
          ...
          <p className="text-gray-500 text-sm mb-1">© 2024 Consultorio Psicológico Integral.</p>
          <div className="flex items-center justify-center gap-1.5 text-[10px] text-gray-400 mb-4 opacity-70 hover:opacity-100 transition-opacity cursor-default">
            <span>Desarrollado por</span>
            <span className="font-semibold text-gray-500">Eduardo Ricci</span>
          </div>
          <button 
